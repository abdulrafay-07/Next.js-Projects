...
const FeaturedSection = () => {
    const featuredCourses = coursesData.courses.filter((course: CourseProps) => course.isFeatured);
                        ...
                        <div key={course.id} className="flex justify-center">
                            ...
                            >
                                <div className="p-4 sm:p-6 flex flex-col items-center text-center flex-grow">
                                    ...
                                    <Link href="/" className="my-4 border-2 border-zinc-100 px-4 py-2 rounded-md hover:text-black text-white hover:bg-zinc-100 transition ease-linear">
                                        Learn more
                                    </Link>
                                </div>
                            </BackgroundGradient>
